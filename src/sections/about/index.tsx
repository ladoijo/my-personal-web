...
import { WorkExperiences } from '@/constants/ExperienceConst';
      ...
      <div className="flex flex-col space-y-5 lg:flex-row lg:space-y-0 lg:space-x-5">
        ...
        >
          <div className={`group relative flex w-full flex-1 lg:h-full`}>
            <div
              className={`
          h-48 w-full rotate-2 rounded-lg border border-gray-300
          bg-white transition-transform duration-300
          ease-in-out group-hover:scale-105 group-hover:rotate-[5deg]
              `}
            ></div>
            <div
              className={`
          absolute z-1 flex h-48 w-full items-center justify-center rounded-lg border
          border-gray-300 bg-white p-4 transition-transform duration-300
          ease-in-out group-hover:scale-105
            ...
            >
              <div className="flex h-full w-full flex-row space-x-2">
                ...
                <ExperienceIcon className="flex h-full w-full flex-1 items-center justify-center text-gray-400" />
              </div>
            </div>
          </div>
          <div className={`group relative flex w-full flex-1 lg:h-full`}>
            ...
            >
              <div className="flex h-full w-full flex-row space-x-2">
                <div className="flex flex-1 flex-col items-center justify-center">
                  ...
                  <p className="text-base text-gray-600">Companies</p>
                </div>
                <CompanyIcon className="flex h-full w-full flex-1 items-center justify-center text-gray-400" />
              </div>
            </div>
          </div>
        </div>
